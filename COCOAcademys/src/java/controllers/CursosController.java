...
public class CursosController implements Serializable {
    ...
    @EJB
    private facades.CursosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/utilities/Bundle").getString("CursosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/utilities/Bundle").getString("CursosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/utilities/Bundle").getString("CursosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
