...
public class UsuariosController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/utilities/Bundle").getString("UsuariosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/utilities/Bundle").getString("UsuariosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/utilities/Bundle").getString("UsuariosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
