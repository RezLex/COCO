...
public class AlumnosController implements Serializable {
    ...
    @EJB
    private facades.AlumnosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/utilities/Bundle").getString("AlumnosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/utilities/Bundle").getString("AlumnosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/utilities/Bundle").getString("AlumnosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Alumnos getAlumnos(java.lang.String id) {
