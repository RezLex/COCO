...
<body>
<h1 style="text-align: center;"><span style="background-color: #CC0606; color: #ffffff;"><img src="logo_sep.png" width="141" height="149" />Eliminar Docente<img src="logo_ceti.png" width="192" height="148" /></span></h1>
<div class="form">

<form name="Registro" method="POST" action="act_doc_del.php" >
<?php
...
Seleccionar Docente
<br>    
<select name= "Mtr" value = "0">
 <?php
 $sql = "select id_docente, nombre, apellido_paterno, apellido_materno from docente";
