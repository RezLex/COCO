...
mysqli_query($conectar,"SET NAMES 'utf8'");
    $N=  $_SESSION['nombre']; 
    $Mt= $_SESSION['registro'];
    $Pass=$_POST['newPss'];
    $stat = "";



    $sql = "update alumno set password = AES_ENCRYPT('$Pass','1234') where registro = $Mt";
    if (mysqli_query($conectar,$sql)) {
        $stat="Contraseña Modificada";
        ob_start(); 
                header("refresh:2; url=Ver_Datos_Alumnos.php");
        ob_end_flush();
    } else {
...
?>
    <h1 style="text-align: center;"><span style="background-color: #ff6600; color: #ffffff;"><img src="logo_sep.png" width="141" height="149" /><?php echo $stat ?><img src="logo_ceti.png" width="192" height="148" /></span></h1>
