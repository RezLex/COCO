...
mysqli_query($conectar,"SET NAMES 'utf8'");
    ...
    $sql = "insert into docente (`id_docente`, `id_academia`, `apellido_materno`, `apellido_paterno`, `nombre`, `password`) values ($Mt, $Ac, '$AM', '$AP', '$N', AES_ENCRYPT('$Pass','1234'))";
    if (mysqli_query($conectar,$sql)) {
        $stat="Docente ".$N. " registrado";
        ob_start(); 
