...
<body>
<h1 style="text-align: center;"><span style="background-color: #0074FF; color: #ffffff;"><img src="logo_sep.png" width="141" height="149" />Cambiar contraseña<img src="logo_ceti.png" width="192" height="148" /></span></h1>
<div class="form">

<form name="Registro" method="POST" action="act_MaestrosPass.php" >
<?php
