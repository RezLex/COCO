...
mysqli_query($conectar,"SET NAMES 'utf8'");
    ...
    $sql = "update alumno set REGISTRO = $Re, DOMICILIO = '$D', CELULAR = $Cel, SEXO = '$Sx', APELLIDO_MATERNO = '$AM', APELLIDO_PATERNO = '$AP', COLONIA = '$Col', NOMBRE = '$N', password = AES_ENCRYPT('$Pass','1234'), CLAVE_MUNICIPIO = $M, ID_CARRERA = $C where registro = $R";
    if (mysqli_query($conectar,$sql)) {
      $stat="Alumno ".$N. " modificado";
      ob_start(); 
